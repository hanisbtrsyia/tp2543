...
<?php include_once 'nav_bar.php'; ?>
    ...
    <form action="orders.php" method="post"class="form-horizontal">
     <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="order_id" type="text" class="form-control" id="order_id" placeholder="Order ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>" readonly>
          </div>
        </div>
      <div class="form-group">
      ...
      <div class="form-group">
          <label for="cust_id" class="col-sm-3 control-label">Customer</label>
          <div class="col-sm-9">
