...
?>
<?php
  include_once 'products_crudsv.php';
?>
...
<body>
  <?php include_once 'nav_barSv.php'; ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <form action="productsSv.php" method="post" class="form-horizontal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center><img src="products/<?php echo $readrow['fld_product_image'] ?>" style="width: 200px" class="img-thumbnail"></center><br/><br/>
  ...
  Details
          ...
          <!--<a href="products_detailsSv.php?prod_id=<?php echo $readrow['fld_product_id']; ?>" class="btn btn-warning btn-xs" role="button" data-toggle="modal" data-target="#myModal">Details</a>-->
          <a href="productsSv.php?edit=<?php echo $readrow['fld_product_id']; ?>" class="btn btn-success btn-xs" role="button"> Edit </a>
          <a href="productsSv.php?delete=<?php echo $readrow['fld_product_id']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="productsSv.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"productsSv.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"productsSv.php?page=$i\">$i</a></li>";
          ?>
