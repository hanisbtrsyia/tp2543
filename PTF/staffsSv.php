...
?>
<?php
  include_once 'staffs_crudsv.php';
?>
...
<div class="container-fluid">
  <div class="row">
    ...
    <form action="staffsSv.php" method="post" class="form-horizontal">
      <div class="form-group">
        <label for="staffid" class="col-sm-3 control-label" >Staff ID</label>
        <div class="col-sm-9">
        <input name="staff_id" type="text" class="form-control" id="staffid" placeholder="Staff ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_id']; ?>">
        </div>
        </div>
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-9">
           <select name="staffrole" class="form-control" id="staffrole"required>
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input name="staff_gender" type="radio" id="staffgender" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_gender']=="Female") echo "checked"; ?> required> Female</label>
              </div>
          </div>
      </div>
              <div class="form-group">
    ...
    <tr>
      ...
      <tr>
        ...
        <td>
          <a href="staffsSv.php?edit=<?php echo $readrow['fld_staff_id']; ?>" class="btn btn-success btn-xs" role="button">Edit</a>
          <a href="staffsSv.php?delete=<?php echo $readrow['fld_staff_id']; ?>" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="staffsSv.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"staffsSv.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"staffsSv.php?page=$i\">$i</a></li>";
          ?>
