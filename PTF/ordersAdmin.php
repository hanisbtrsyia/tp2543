...
?>
<?php
  include_once 'orders_crudAdmin.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  <?php include_once 'nav_barAdmin.php'; ?>
    ...
    <form action="ordersAdmin.php" method="post" class="form-horizontal">
    ...
    <tr>
      ...
      <tr>
        ...
        <td>
          <a href="orders_detailsAdmin.php?order_id=<?php echo $orderrow['fld_order_id']; ?>" class="btn btn-warning btn-xs" role="button">Details</a>
          <a href="ordersAdmin.php?edit=<?php echo $orderrow['fld_order_id']; ?>" class="btn btn-success btn-xs" role="button">Edit</a>
          <a href="ordersAdmin.php?delete=<?php echo $orderrow['fld_order_id']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="ordersAdmin.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"ordersAdmin.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"ordersAdmin.php?page=$i\">$i</a></li>";
          ?>
