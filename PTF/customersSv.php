...
?>
<?php
  include_once 'customers_crudsv.php';
?>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
    	...
    	<form action="customersSv.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              	<input name="cust_gender" type="radio" id="custgender" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_cust_gender']=="Female") echo "checked"; ?>required> Female</label>
            </div>
          </div>
      </div>
    ...
    <tr>
      ...
      <tr>
        ...
        <td>
          <a href="customersSv.php?edit=<?php echo $readrow['fld_cust_id']; ?>" class="btn btn-success btn-xs" role="button">Edit</a>
          <a href="customersSv.php?delete=<?php echo $readrow['fld_cust_id']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="customersSv.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"customersSv.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"customersSv.php?page=$i\">$i</a></li>";
          ?>
