...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_customers_a175416_pt2(fld_cust_id, fld_cust_name, fld_cust_gender, fld_cust_email, fld_cust_phone) VALUES(:cust_id, :cust_name, :cust_gender, :cust_email, :cust_phone)");
...
if (isset($_POST['update'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_customers_a175275 SET fld_cust_id = :cust_id, fld_cust_name = :cust_name, fld_cust_gender = :cust_gender, fld_cust_email = :cust_email, fld_cust_phone = :cust_phone WHERE fld_cust_id = :oldcid");
