    ...
    <div class="container-fluid">
      ...
      <div class="form-group">
          ...
          <input name="prod_quantity" type="number" class="form-control" id="prod_quantity" placeholder="Quantity" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_quantity']; ?>" min="0" required>
           ...
           <!--<tr>
              <td>Product Image</td>
              <td><input type="file" name="prod_image" type="text" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_image']; ?>"></td>
            </tr>
            <tr>
              <td></td>
              <td>-->
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      <tr>
        ...
        <td>
          <a href="products_details.php?prod_id=<?php echo $readrow['fld_product_id']; ?>" class="btn btn-warning btn-xs" role="button">Details</a>
