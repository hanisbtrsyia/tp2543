...
<body>
  <?php include_once 'nav_barStaff.php'; ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <form action="productsStaff.php" method="post" class="form-horizontal">
  ...
  Details
          ...
          <!--<a id="products_detailsStaff.php?prod_id=<?php //echo $readrow['fld_product_id']; ?>" class="btn btn-warning btn-xs" role="button" onclick="showDetails(this)" data-target="#prodDetails" >Details</a>
          <button id="<?php echo $readrow->fld_product_id; ?>" class="btn btn-warning btn-xs" role="button" onclick="showDetails(this)" data-target="#prodDetails">Details</button>-->
          <a href="productsStaff.php?edit=<?php echo $readrow['fld_product_id']; ?>" class="btn btn-success btn-xs" role="button"> Edit </a>
          <a href="productsStaff.php?delete=<?php echo $readrow['fld_product_id']; ?>" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="productsStaff.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"productsStaff.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"productsStaff.php?page=$i\">$i</a></li>";
          ?>
