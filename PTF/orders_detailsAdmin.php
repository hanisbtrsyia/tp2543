...
?>
<?php
  include_once 'orders_details_crudAdmin.php';
?>
...
<body>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <form action="orders_detailsAdmin.php" method="post" class="form-horizontal" name="frmorder" id="forder">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <tr>
        ...
        <td>
          <a href="orders_detailsAdmin.php?delete=<?php echo $detailrow['fld_order_detail_id']; ?>&order_id=<?php echo $_GET['order_id']; ?>" onclick="return confirm('Are you sure to delete?');"  class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
