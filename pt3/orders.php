  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="oid" type="text" class="form-control" id="oid" placeholder="Order ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_num']; ?>" required>
        </div>
        </div>
         <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
              <select name="sid" class="form-control" id="sid" required>
                ...
                try {
                  ...
                  $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a175218");
                  $stmt->execute();
          ...
          <div class="form-group">
            <label for="cid" class="col-sm-3 control-label">Staff</label>
            <div class="col-sm-9">
              <select name="cid" class="form-control" id="cid" required>
                ...
                try {
                  $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                  $stmt = $conn->prepare("SELECT * FROM tbl_customers_a175218");
                  $stmt->execute();
                  $result = $stmt->fetchAll();
                }
                catch(PDOException $e){
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
              $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $sql = "SELECT * FROM tbl_orders_a175218, tbl_staffs_a175218, tbl_customers_a175218 WHERE ";
              $sql = $sql."tbl_orders_a175218.fld_staff_num = tbl_staffs_a175218.fld_staff_num and ";
              $sql = $sql."tbl_orders_a175218.fld_customer_num = tbl_customers_a175218.fld_customer_num ORDER BY tbl_orders_a175218.fld_order_date DESC LIMIT {$start_from}, {$per_page}";
          ...
          <nav>
            <ul class="pagination">
              ...
              try {
                ...
                $sql = "SELECT * FROM tbl_orders_a175218, tbl_staffs_a175218, tbl_customers_a175218 WHERE ";
                $sql = $sql."tbl_orders_a175218.fld_staff_num = tbl_staffs_a175218.fld_staff_num and ";
                $sql = $sql."tbl_orders_a175218.fld_customer_num = tbl_customers_a175218.fld_customer_num LIMIT {$start_from}, {$per_page}";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
                $result = $stmt->fetchAll();
