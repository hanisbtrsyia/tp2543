...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_staffs_a175218_pt2(FLD_STAFF_ID, FLD_STAFF_NAME, FLD_ADDRESS,
      FLD_PHONE) VALUES(:sid, :name, :address,:phone)");
...
if (isset($_POST['update'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_staffs_a175218_pt2 SET
      FLD_STAFF_ID = :sid, FLD_STAFF_NAME = :name, FLD_ADDRESS = :address,
