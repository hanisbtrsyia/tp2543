...
<div class="col-xs-6 text-right">
  ...
  <h5>Date: <?php echo $readrow['FLD_DATE_ORDER'] ?></h5>
</div>
</div>
<hr>
<div class="row">
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Syalectric Sdn. Bhd.</h4>
      </div>
      <div class="panel-body">
        <p>
        LOT 8-10A GROUND FLOOR, <br>
    ...
    <div class="col-xs-5 col-xs-offset-2 text-right">
        ...
        <p>
        No.15, <br>
        Jalan Impian Makmur <br>
        2/3, Saujana Impian, <br>
        43000 Kajang, Selangor <br>
        </p>
            </div>
        </div>
    ...
    <div class="span7">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <p> Phone: <?php echo $readrow['FLD_PHONE'] ?> </p>
          <p><br></p>
          <p><br></p>
