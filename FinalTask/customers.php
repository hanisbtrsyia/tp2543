...
<div class="container-fluid" style="color:black">
  <div class="row" >
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header" > 
        <center><div><font color="#7f0000" face="Fantasy" style="font-size:3vw">Create New Customer</font></div></center>
      </div>
    ...
    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form-horizontal">
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="email" type="text" class="form-control" id="email" placeholder="Email" value="<?php if(isset($_GET['edit'])) echo $editrow['FLD_EMAIL']; ?>" required>
        </div>
        </div>
        <div class="form-group">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <div class="page-header">
        <div><font color="#000000" face="fantasy" style="font-size:33px">Customer List</font></div>
      </div>
      ...
      try {
        ...
        $stmt = $conn->prepare("select * from tbl_customers_a175218_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
