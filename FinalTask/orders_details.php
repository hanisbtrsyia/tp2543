...
<div class="container-fluid" style="color:black">
      ...
      <div class="panel panel-default">
        ...
        <table class="table" border="1px">
          ...
          <tr>
            ...
            <td><?php echo $readrow['FLD_DATE_ORDER'] ?></td>
          </tr>
          <tr>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
        <div><font color="#000000" face="fantasy" style="font-size:30px">Add a Product</font></div>
      </div>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
         <div><font color="#000000" face="fantasy" style="font-size:30px">Products in This Order</font></div>
      </div>
      <table class="table" border="1px">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <a href="invoice.php?oid=<?php echo $_GET['oid']; ?>" target="_blank" role="button" class="btn btn-default btn-lg btn-block" style="background-color: #1b1b1b; color:white;" >Generate Invoice</a>
    </div>
  </div>
  <br>
</div>
