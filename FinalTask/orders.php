...
<div class="container-fluid" style="color:black">
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
       <center><div><font color="#7f0000" face="Fantasy" style="font-size:3vw">Create New Order</font></div></center>
      </div>
    <form action="orders.php" method="post" class="form-horizontal">
      <div class="form-group">
          <label for="oid" class="col-sm-3 control-label">Order ID</label>
          <div class="col-sm-9">
           <input name="oid" type="text" class="form-control" id="orderid" placeholder="Order ID" readonly value="<?php echo (isset($_GET['edit']) ? $_GET['edit'] : uniqid('O', true)); ?>">
            </div>
        </div>
        <div class="form-group">
          <label for="orderdate" class="col-sm-3 control-label">Order Date</label>
          <div class="col-sm-9">
         <input name="orderdate" type="text" class="form-control" id="orderdate" placeholder="Order Date" readonly value="<?php echo (isset($_GET['edit']) ? $editrow['FLD_DATE_ORDER'] : date('d-m-Y')); ?>">
            </div>
        </div>
        <div class="form-group">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <div class="page-header">
        <div><font color="#000000" face="fantasy" style="font-size:33px">Order List</font></div>
      </div>
      ...
      try {
              ...
              $sql = $sql."tbl_orders_a175218_pt2.FLD_CUSTOMER_ID = tbl_customers_a175218_pt2.FLD_CUSTOMER_ID ORDER BY tbl_orders_a175218_pt2.FLD_DATE_ORDER DESC LIMIT {$start_from}, {$per_page}";
          ...
          <nav>
            <ul class="pagination">
              ...
              try {
                ...
                $sql = "SELECT * FROM tbl_orders_a175218_pt2, tbl_staffs_a175218_pt2, tbl_customers_a175218_pt2 WHERE ";
                $sql = $sql."tbl_orders_a175218_pt2.FLD_STAFF_ID = tbl_staffs_a175218_pt2.FLD_STAFF_ID and ";
                $sql = $sql."tbl_orders_a175218_pt2.FLD_CUSTOMER_ID = tbl_customers_a175218_pt2.FLD_CUSTOMER_ID LIMIT {$start_from}, {$per_page}";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
                $result = $stmt->fetchAll();
