                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
                    <div class="col-sm-offset-2 col-sm-8">
                        <div class="form-group">
                            <label for="inputKeyword">Keywords (Name, Price, Cat ID)</label>
            ...
            <table class="table table-bordered">
                ...
                if (isset($_POST['search'])) {
                    ...
                    if (count($keywords) == 3) {
                        $name = $keywords[0]."%";
                        $price = $keywords[1]."%";
                        $categoryid = $keywords[2]."%";

                        $stmt = $db->prepare("SELECT * FROM tbl_products_a175218_pt2 WHERE FLD_PRODUCT_NAME LIKE :name AND FLD_PRICE LIKE :price AND FLD_CATEGORY_ID LIKE :categoryid ORDER BY FLD_PRODUCT_ID ASC");
                    ...
                    $stmt = $db->query("SELECT * FROM tbl_products_a175218_pt2 ORDER BY FLD_CATEGORY_ID ASC LIMIT 0,10");
                    $result = $stmt->fetchAll(PDO::FETCH_ASSOC);
                }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img class="product-image" src="nophoto.png" alt="No Photo" class="img-rounded"
